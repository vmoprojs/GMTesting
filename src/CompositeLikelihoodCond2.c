...
if(!ISNAN(data1[i])&&!ISNAN(data2[i]) ){
  //Rprintf("%f %f %f  %d\n",lags[i],data1[i],data2[i],*npairs);
                      ...
                      bl=log_biv_Norm(corr,data1[i],data2[i],mean1[i],mean2[i],sill,nugget);
                      l1= dnorm(data1[i], mean1[i],sqrt(sill+nugget),1);
                      l2= dnorm(data2[i], mean2[i],sqrt(sill+nugget),1);
